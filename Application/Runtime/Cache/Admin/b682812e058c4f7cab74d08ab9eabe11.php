...
<div class="page-container">
	<div class="text-c"> 日期范围：
		<input type="text" name="start_time" id="countTimestart" onfocus="selecttime(1)" value="<?php echo ($start_time); ?>" size="17" class="input-text Wdate" readonly style="width:180px"> 
		- 
		<input type="text" name="end_time" id="countTimeend" onfocus="selecttime(2)" value="<?php echo ($end_time); ?>" size="17"  class="input-text Wdate" readonly style="width:180px">
