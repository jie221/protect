...
<aside class="Hui-aside">
	...
	<dl id="menu-product">
		...
		<dd>
			<ul>
				<li><a data-href="<?php echo U('/Article/index');?>" data-title="品牌管理" href="javascript:void(0)">文章列表</a></li>
	...
	<dl id="menu-comments">
		...
		<dd>
			<ul>
				<li><a data-href="<?php echo U('/Comment/index');?>" data-title="评论列表" href="javascript:;">评论列表</a></li>
